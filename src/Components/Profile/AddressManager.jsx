    ...
    return (
        <>
            {view === "manageAddress" ? (
                ...
                <>
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white mt-8 sm:mt-0 md:mt-0">Add Address</h2>
                    <AddressForm
                        addressData={addressData}
                        setAddressData={setAddressData}
                        onSubmit={async () => {
    ...
    <li className="border-b last:border-b-0 pb-4 border-gray-200 dark:border-gray-600">
        <div className="flex justify-between items-start">
            <div className="flex flex-col space-y-2">
                <p className="text-sm text-gray-500 dark:text-gray-400">Type: {address.Type}</p>
                <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                    {address.Name}
                </h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">{address.Mobile}</p>
            </div>

...
const Sidebar = ({ view, setView, isMobileNavOpen, setIsMobileNavOpen }) => {
    return (
        <>
            ...
            {/* Sidebar */}
            <div
                className={`${isMobileNavOpen ? "fixed inset-0 z-50 bg-white dark:bg-gray-800 w-64" : "hidden"
                    } md:block md:w-1/4 md:relative border-r border-gray-300 dark:border-gray-700 pt-4`}
            >

                <Link className="md:hidden text-3xl font-bold text-blue-600 hover:text-blue-800 transition duration-200 ml-4" to="/">
                    King Cart
                </Link>
    ...
    <ul className="pl-4 space-y-2 text-sm">
        <li className="hover:text-blue-600 dark:hover:text-blue-400">Gift Cards</li>
        <li className="hover:text-blue-600 dark:hover:text-blue-400">Saved UPI</li>
        <li className="hover:text-blue-600 dark:hover:text-blue-400">Saved Cards</li>
    </ul>

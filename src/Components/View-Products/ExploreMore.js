...
function ExploreMore() {
    ...
    const [visibleCount, setVisibleCount] = useState(8); // Initially showing 8 products
    ...
    const loadMoreProducts = () => {
        const newVisibleCount = visibleCount + 8; // Increase visible count by 8
        setVisibleCount(newVisibleCount);
        setProducts(allProducts.slice(0, newVisibleCount)); // Update products to show more
    };

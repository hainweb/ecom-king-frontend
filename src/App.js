...
function App() {
  ...
  const ProtectedRoute = ({ component: Component }) => {
    return user ? <Component /> : <Login setUser={setUser} setCartCount={setCartCount} />;
  };
      ...
      <Router>
        ...
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            ...
            <Route path="/place-order" element={user? <PlaceOrder setCartCount={setCartCount}/> : <Login setUser={setUser} setCartCount={setCartCount} />} />
            ...
            <Route path="/search" element={<Search user={user} darkMode={darkMode} cartCount={cartCount} setDarkMode={setDarkMode} />} />
              <Route path="/product/:id" element={<ProtectedRoute component={ProductDisplay} />} />
